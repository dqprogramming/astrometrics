# Generated by Django 5.2.12 on 2026-03-20 10:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sort_order', models.PositiveIntegerField(default=0)),
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='members', to='cms.teamsection')),
            ],
            options={
                'ordering': ['sort_order'],
            },
