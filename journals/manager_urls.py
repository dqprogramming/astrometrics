...
urlpatterns = [
    ...
    path("journals/<int:pk>/tags/<str:field>/search/",           views.JournalTagSearchView.as_view(), name="journal_tag_search"),
    path("journals/<int:pk>/tags/<str:field>/add/",              views.JournalTagAddView.as_view(),    name="journal_tag_add"),
    path("journals/<int:pk>/tags/<str:field>/<int:item_pk>/remove/", views.JournalTagRemoveView.as_view(), name="journal_tag_remove"),

    # Archiving Services
    path("archiving-services/",               views.ArchivingServiceListView.as_view(),   name="archivingservice_list"),
    path("archiving-services/new/",           views.ArchivingServiceCreateView.as_view(), name="archivingservice_create"),
    path("archiving-services/<int:pk>/edit/", views.ArchivingServiceUpdateView.as_view(), name="archivingservice_edit"),
    path("archiving-services/<int:pk>/delete/", views.ArchivingServiceDeleteView.as_view(), name="archivingservice_delete"),
    ...
    path("languages/new/",               views.LanguageCreateView.as_view(),  name="language_create"),
    ...
    # Package Bands
    path("package-bands/",               views.PackageBandListView.as_view(),   name="packageband_list"),
    path("package-bands/new/",           views.PackageBandCreateView.as_view(), name="packageband_create"),
    path("package-bands/<int:pk>/edit/", views.PackageBandUpdateView.as_view(), name="packageband_edit"),
    path("package-bands/<int:pk>/delete/", views.PackageBandDeleteView.as_view(), name="packageband_delete"),
